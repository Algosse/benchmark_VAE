...
class VDVAEConfig(VAEConfig):
    ...
    Parameters:
        ...
        custom_width_str (str): A string to specify custom width for each resolution.
    ...
    reconstruction_loss: Literal["bce", "mse", 'dmol'] = "dmol"
    width: int = 16
    custom_width_str: str = "32:16,16:32,8:64,4:128,1:256"
